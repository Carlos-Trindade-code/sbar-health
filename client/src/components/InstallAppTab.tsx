...
export function InstallAppTab() {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h2 className="text-xl font-semibold">SBAR Global no seu celular</h2>
      ...
      <Accordion type="single" collapsible defaultValue="benefits">
      ...
      {/* Instructions by device - Accordion with tabs inside */}
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <Tabs defaultValue={defaultTab}>
            ...
            <TabsContent value="ios" className="space-y-4">
              ...
              <Accordion type="single" collapsible defaultValue="ios-steps">
                <AccordionItem value="ios-steps">
                  <AccordionTrigger>Ver passos detalhados</AccordionTrigger>
                  <AccordionContent>
            ...
            <TabsContent value="android" className="space-y-4">
              ...
              <Accordion type="single" collapsible defaultValue="android-steps">
            ...
            <TabsContent value="desktop" className="space-y-4">
              ...
              <Accordion type="single" collapsible defaultValue="desktop-steps">
                <AccordionItem value="desktop-steps">
                  <AccordionTrigger>Ver passos detalhados</AccordionTrigger>
                  <AccordionContent>
                    <div className="space-y-3 pt-2">
                      <Step
